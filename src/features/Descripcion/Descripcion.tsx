    ...
    <div className="w-[100vw] h-[100vh] flex items-center justify-center flex-row box-border ">
      <section className="w-[100%] h-[100%] flex items-center justify-center flex-col bg-[#F3F4F6] py-[15px]  ">
        ...
        <section className="w-[100%] h-[100%] flex items-center justify-center flex-col mb-10">
          <div className=" w-[80%] h-[100%] max-[850px]:w-[95%] max-[850px]:px-[0px] flex items-center justify-between flex-row my-1 px-[15px]  rounded-[5px] border-[1px] border-[#DEE1E6] border-solid ">
            <img src={iconUserSrc} alt="" className="max-[850px]:size-[30px]" />
            ...
            />
            <span className=" text-center max-[850px]:text-[12px] ">Box 1</span>
          ...
          <div className=" w-[80%] h-[100%] max-[850px]:w-[95%] max-[850px]:px-[0px] flex items-center justify-between flex-row my-1 px-[15px] rounded-[5px] border-[1px] border-[#DEE1E6] border-solid ">
            ...
            <img
              ...
              className="max-[850px]:size-[15px] "
            />
            <span className=" text-center max-[850px]:text-[12px]">Box 2</span>
            <span className=" h-[65%] text-center max-[850px]:text-[12px]">
              HH MM
            </span>
          </div>
          <div className=" w-[80%] h-[100%] max-[850px]:w-[95%] max-[850px]:px-[0px] flex items-center justify-between flex-row  my-1 px-[15px] rounded-[5px] border-[1px] border-[#DEE1E6] border-solid ">
            ...
            <img
              ...
              className="max-[850px]:size-[15px] "
            />
            <span className=" text-center max-[850px]:text-[12px]">Box 3</span>
            <span className=" h-[65%] text-center max-[850px]:text-[12px]">
              HH MM
            </span>
          </div>
          <div className=" w-[80%] h-[100%] max-[850px]:w-[95%] max-[850px]:px-[0px] flex items-center justify-between flex-row  my-1 px-[15px] rounded-[5px] border-[1px] border-[#DEE1E6] border-solid ">
            ...
            <img
              ...
              className="max-[850px]:size-[15px] "
            />
            <span className=" text-center max-[850px]:text-[12px]">Box 4</span>
            <span className=" h-[65%] text-center max-[850px]:text-[12px]">
              HH MM
            </span>
          </div>
          <div className=" w-[80%] h-[100%] max-[850px]:w-[95%] max-[850px]:px-[0px] flex items-center justify-between flex-row  my-1 px-[15px] rounded-[5px] border-[1px] border-[#DEE1E6] border-solid ">
            ...
            <img
              ...
              className="max-[850px]:size-[15px] "
            />
            <span className=" text-center max-[850px]:text-[12px]">Box 5</span>
            <span className=" h-[65%] max-[850px]:text-[12px]">HH MM</span>
          </div>
        </section>
      </section>
      <section className="w-[100%] h-[100%] max-[1150px]:pt-[13%] max-[950px]:pt-[16%]  max-[750px]:pt-[22%] flex  items-center justify-center flex-col bg-[#323842] pt-[9%] pb-[2%]">
        ...
        <button className="w-[50%] h-[100%] max-[1150px]:h-[60%] max-[1150px]:w-[60%] max-[950px]:h-[50%] max-[950px]:w-[65%]  max-[750px]:h-[40%] max-[750px]:w-[90%]  bg-[#FFFFFF] my-[10px] rounded-[10px]">
          <h2 className="text-[32px] max-[950px]:text-[25px]">IMC 12</h2>
          <span className="text-[18px] max-[950px]:text-[17px]">Box 2</span>
        </button>

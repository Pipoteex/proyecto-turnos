    ...
    <div className=" relative w-[100vw] h-[100vh] bg-gradient-to-br from-[#347dce] flex items-center justify-center flex-col">
      <div className="w-[100%] h-[100%] relative ">
        <img
          ...
          alt=""
          className=" w-[32%] absolute right-[13%] z-[1]"
        />
        <img
          src={misionesRedSrc}
          alt=""
          className=" w-[32%] absolute right-[10%] z-[2]"
        />
      </div>

      <div className=" relative w-[100%] h-[80%] flex items-center justify-center flex-col bg-[#003C60]">
        <img
          src={logoSrc}
          alt=""
        ...
        <div className=" flex items-center justify-center flex-col absolute bottom-[20%]  ">
